...
cd ..
mv $DEB_PACKAGE_*.deb . 2>/dev/null || true
mv $DEB_PACKAGE_*.build . 2>/dev/null || true
mv $DEB_PACKAGE_*.buildinfo . 2>/dev/null || true
mv $DEB_PACKAGE_*.changes . 2>/dev/null || true
