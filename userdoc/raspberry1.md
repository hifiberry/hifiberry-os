...
BR2_TARGET_GENERIC_HOSTNAME="hifiberry"
BR2_TARGET_GENERIC_ISSUE="Welcome to HiFiBerryOS"
...
BR2_TARGET_GENERIC_ROOT_PASSWD="hifiberry"
...
BR2_PACKAGE_ESPEAK_AUDIO_BACKEND_NONE=y
# BR2_PACKAGE_ESPEAK_AUDIO_BACKEND_ALSA is not set
# BR2_PACKAGE_ESPEAK_AUDIO_BACKEND_PULSEAUDIO is not set
BR2_PACKAGE_FAAD2=y
...
# BR2_PACKAGE_GST1_VAAPI_ENCODERS is not set
...
BR2_PACKAGE_NODEJS_MODULES_ADDITIONAL="aplay eventemitter3 express dnssd2 websocket wireless-tools underscore country-list xml-js request node-tunein-radio node-cec serialport node-fetch"
...
BR2_PACKAGE_PYTHON_XMLTODICT=y
...
# HIFIBERRY_TEST_BEOCREATE is not set
# HIFIBERRY_TEST_DACADC is not set
